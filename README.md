...
PROMPT_NAME = "test_prewarm"   # <-- choose a prompt set name
...
# ===============================================================
# Input data — requirements to review
# ===============================================================
requirements = [
...
# ===============================================================
# Instantiate rate-limited OpenAI client
# ===============================================================
...
# ===============================================================
# Async processing of requirements
# ===============================================================
async def run_req_review_with_processor(client, input_df, model):
    """
    Execute concurrent prompt runs over all requirements using PromptProcessor.
    """
    processor = PromptProcessor(client=client, input_df=input_df, model=model)
    items = processor.df_to_prompt_items(input_df, ["requirement_id", "requirement"])
